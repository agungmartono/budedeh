                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Nama Pasien" name="name" value="{{ old('name') }}">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror">
                                                <option></option>
                                                <option value="0" @selected(old('gender') == '0')>
                                                    Laki - laki
                                                </option>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="phone_number" id="phone_number" class="form-control @error('phone_number') is-invalid @enderror" placeholder="08XX-XXXX-XXXX">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" id="address" cols="3" rows="3" placeholder="Alamat Lengkap" class="form-control @error('address') is-invalid @enderror">{{ old('address') }}</textarea>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('pob') is-invalid @enderror" id="pob" placeholder="Tempat Lahir" name="pob" value="{{ old('pob') }}">
